...
function Mat(){
  var material = new THREE.MeshPhongMaterial({
    color      : new THREE.Color("rgb(213, 188, 34)"),  //Diffuse color of the material
    emissive   : new THREE.Color("rgb(255,230,82)"), //Emissive(light) color of the material, essentially a solid color unaffected by other lighting. Default is black.
    ...
    transparent: 1,
    opacity    : 0.8                                //THREE.Math.randFloat(0,1)
  });
  return material;
}
...
function onDocumentMouseMove(event) {
    ...
    camera.position.z = 80 - 10 * mouse.x;
